...
export const CHECKLIST_FIELDS = Object.freeze({
    ...
    activity: { label: "活动量", options: [["静止", [/静止|不动/u]], ["偏低", [/低活动|活动少|少动/u]], ["正常", [/活动正常|适中|正常活动/u]], ["过度", [/过度|躁动|活动过强/u]]] },
    ...
    secretion: { label: "分泌情况", options: [["无", [/^无$/u, /无分泌|无明显分泌|未见(?:明显)?分泌|干燥/u]], ["少量", [/少量|少量分泌/u]], ["明显", [/明显分泌|较多|渗出/u]], ["异常", [/异常|脓|异味/u]]] },
